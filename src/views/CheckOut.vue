<template>
  <v-card :elevation="0">
    <v-container fluid>
      <v-row>
        <v-col cols="12" lg="7" md="7" class="pa-sm-0">
          <v-card :elevation="0">
            <v-card-title class="pl-0 text-left"> new-ella-demo </v-card-title>
            ...
            <v-card-text>
              <p class="text-center text-grey">Express checkout</p>
            </v-card-text>
            <v-card-actions class="w-100 d-flex justify-center align-center">
              <v-btn
                style="background-color: #5912e3; height: 50px"
                class="w-50"
              >
                <svg
                  width="80"
              ...
              <v-btn style="background-color: black; height: 50px" class="w-50">
            ...
            <v-card-text class="pl-0 d-flex justify-space-around align-center">
              <span
                style="width: 45%; height: 1px"
                class="bg-grey-lighten-2"
              ></span>
              <span class="text-grey-darken-1">OR</span>
              <span
                style="width: 45%; height: 1px"
                class="bg-grey-lighten-2"
              ></span>
            </v-card-text>
            <v-card-text class="pl-0 d-flex justify-space-between align-center">
            ...
            <div class="check d-flex align-center" style="gap: 10px">
              <input type="checkbox" value="checked" />
              <span>Email me with news and offers</span>
            </div>
            <v-card-text class="pl-0">
              <h3 class="text-left">Delivery method</h3>
              <v-radio-group>
                <div class="d-flex justify-center align-center">
                  ...
                  <span><v-icon>mdi-truck-outline</v-icon></span>
                </div>
                <div class="d-flex justify-center align-center">
                  <v-radio value="two">
                    <template v-slot:label>
                  ...
                  <span><v-icon>mdi-shopping-outline</v-icon></span>
                </div>
              </v-radio-group>
            </v-card-text>
            <v-card-text class="w-100 pl-0 pb-0">
            ...
            <v-card-text
              class="pl-0 pt-0 pb-0 d-flex align-center justift-space-between"
              style="gap: 10px"
            >
              <v-text-field
                class="w-50"
            ...
            <v-card-text class="pl-0 pt-0 pb-0 mt-0">
              <v-text-field
                placeholder="Address"
                variant="outlined"
              ></v-text-field>
            ...
            <v-card-text
              class="pl-0 pt-0 pb-0 d-flex align-center"
              style="gap: 10px"
            >
              <v-text-field
                placeholder="City"
            ...
            <v-card-actions
              class="d-flex align-center justify-end pr-3 pl-0 mb-9"
            >
              <v-btn
                class="bg-blue-darken-2 text-white font-weight-bold"
            ...
            <v-divider></v-divider>
            <v-card-text class="pl-0 text-grey text-left"
              >All rights reserved new-ella-demo</v-card-text
            >
          </v-card>
        </v-col>
        <v-col cols="12" lg="5" md="5" class="bg-grey-lighten-3 pa-sm-0">
          <v-container fluid>
            <v-row v-for="product in cartItems" :key="product.id" class="mt-5">
              <v-col cols="3">
                <v-badge :content="product.quantity" color="grey-darken-2">
                  <div
              ...
              <v-col cols="8">
                <v-card class="bg-transparent pl-0 w-100" :elevation="0">
                  <div class="d-flex justify-space-between">
                    <v-card-text
                      class="font-weight-bold pl-0 pt-0 pb-2 text-left"
                      style="font-size: 1rem"
                      >(product {{ product.id }}) Sample -
                      {{ product.category }}</v-card-text
                    >
                    <span class="align-self-end pt-0 text-grey-darken-1"
                      >${{
                        Math.ceil(
                          product.price -
                  ...
                  <v-card-text class="text-grey-darken-1 pl-0 pt-0 text-left">{{
                    product.title
                  }}</v-card-text>
                </v-card>
              </v-col>
            ...
            <v-row>
              <v-col cols="12" class="d-flex" style="gap: 10px">
                ...
                ></v-text-field>
                <v-btn
                  class="w-25 bg-grey-lighten-2 align-self-center"
                  style="height: 60px !important; text-transform: none"
                  >Apply</v-btn
                >
              </v-col>
              <v-col
              ...
              >
                <span>Subtotal</span>
                <span class="font-weight-bold">${{ computeTotalPrice }}</span>
              </v-col>
              <v-col
                cols="12"
                class="d-flex justify-space-between align-center"
    ...
    <PopUp :popup="dialog" v-if="dialog" @close-dialog="dialog = false" />
  </v-card>
</template>
...
export default {
  ...
  data: () => ({
    countries: ["Egypt", "Algeria", "Tunisia", "Morroco", "USA", "UK"],
    dialog: false,
  }),
  computed: {
