  ...
  <div class="app-bar">
    ...
    >
      <v-container
        ...
        style="gap: 3em"
      >
        <v-row align="center" class="justify-start mr-2 w-100 mt-4 pl-0 ml-0">
          <v-col cols="3" class="d-flex justify-start pl-0">
            <img
              src="../../assets/logo.png"
              width="180"
              class="pl-0 ml-0"
          ...
          <v-col cols="5" class="d-flex align-center position-relative">
            <input
              type="text"
              class="bg-white w-100 pa-4"
              style="outline: none; border-radius: 100px"
            />
            <v-icon
              color="black"
          ...
          <v-col cols="2" class="pt">
            <span> Availlabel 24/7 at</span>
            <br />
            <span><em>(090) 123-4567</em></span>
          </v-col>
          <v-col cols="2" class="d-flex justify-space-between pt-md-0">
            <div
              class="heart d-flex align-center flex-column justify-space-between"
            >
              <svg viewBox="0 0 512 512" class="icon icon-wishlist" width="30">
                <g>
                  <g>
                    <path
                      fill="#ffb547"
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <span style="color: #ffb547" class="mb-lg-4">Wish List</span>
            </div>
            <div
              class="sign d-flex align-center flex-column justify-space-between mb-lg-4"
            >
              <svg
            ...
            <div
              class="cart d-flex align-center flex-column justify-space-between ml-md-2 mb-md-5"
              @click="displayDrawer()"
        ...
        <v-row align="center">
          ...
          <v-col cols="2"></v-col>
          <v-col cols="2">
            <div class="box_one d-flex align-center">
              ...
              <span class="ml-3 align-center font-weight-regular">Help</span>
            </div>
          </v-col>
          <v-col cols="2">
            <div class="box_two d-flex align-center" style="gap: 3px">
              <div
                class="eng align-center"
                :style="box1 ? 'display: flex' : 'display: none'"
                style="gap: 5px"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                class="germ align-center"
                :style="box2 ? 'display: flex' : 'display: none'"
                style="gap: 5px"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="lang ml-3 d-flex" style="cursor: pointer">
                <div class="menu">
                  <v-menu>
