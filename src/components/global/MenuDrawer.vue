<template>
  <div class="drawer">
    <v-navigation-drawer v-model="drawer" temporary width="400" class="px-2">
      <v-card :elevation="0" class="pt-1 pl-1">
        ...
        <v-list class="pl-2">
          <v-list-item
            ...
            :key="cat.title"
            class="text-left pl-2 font-weight-bold"
            @click="
              $router.push({
            ...
            "
          >
            <v-list-title>{{ cat.title }}</v-list-title>
          </v-list-item>
          <v-list-group class="text-left pl-0">
